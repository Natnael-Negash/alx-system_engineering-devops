...
OA     aliquam aut quasi
OA     veritatis pariatur delectus
OA     nemo perspiciatis repellat ut dolor libero commodi blanditiis omnis
     repellendus veritatis molestias dicta incidunt
OA     excepturi deleniti adipisci voluptatem et neque optio illum ad
     totam atque quo nesciunt
sylvain@ubuntu$ python3 0-gather_data_from_an_API.py 4
OAEmployee Patricia Lebsack is done with tasks(6/20):
